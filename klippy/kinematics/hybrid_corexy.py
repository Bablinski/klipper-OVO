...
class HybridCoreXYKinematics:
    def __init__(self, toolhead, config):
        ...
        # Read configuration options to invert X and Y axes logic
        self.invert_x_axis = printer_config.getboolean('invert_x_axis', False)
        self.invert_y_axis = printer_config.getboolean('invert_y_axis', False)
    ...
    def calc_position(self, stepper_positions):
        ...
        x_factor = -1 if self.invert_x_axis else 1
        y_factor = -1 if self.invert_y_axis else 1
